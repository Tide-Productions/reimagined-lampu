...
namespace reimagined_lampu
{
    ...
    class MainMenu : IGameState
    {
        ...
        public MainMenu(ContentManager Content)
        {
            ...
            options = new Button(active: buttonActive, inactive: buttonInactive, hover: buttonHover, position: new Vector2(950, 100), text: "Options", textPosition: new Vector2(100, 40), state: BtnState.inactive, visibility: false, toolTip: "This feature isn't important, is it?");
